...
::
::fBE1pAF6MU+EWHreyHcjLQlHcD66BleeCaIS5Of66/m7jV0YWqIPaoDR37eaM9w72XbbVpk42G5fivQaXVUKQgGkex03rFJws2WBOsLSpxf1Kg==
::fBE1pAF6MU+EWHreyHcjLQlHcD66BleeCaIS5Of66/m7jV0YWqIPaoDR37eaM9w72XbbVpk42G5fivQaXVUKQgGkex03rFJLuHSQI4meshuB
::YAwzoRdxOk+EWAnk
::fBw5plQjdG8=
...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQImeVUGLA==
::ZQ05rAF9IBncCkqN+0xwdVtCHUrQXA==
::ZQ05rAF9IAHYFVzEqQIYGygUbwuXMn+/FNU=
::eg0/rx1wNQPfEVWB+kM9LVsJDCyxDyuZCaAS/O3pr/zW7B99
::fBEirQZwNQPfEVWB+kM9LVsJDCyxDyuZCaAS/O3pr/zW7B99
...
::Zh4grVQjdCyDJGyX8VAjFCFsdjimM3y0Crod7PvHwPqCrA0tRu01fYzPyYimE9MsyUrxe4IoxEVMyYVeMDNrTS2IYRo6vWtQiXLUeZXSthfkKg==
::YB416Ek+ZG8=
::
::
::978f952a14a936cc963da21a135fa983
@echo off
title HSS Counter v1.2
color 0d
...
::HSS Counter v1.2
::Author: @mribraqdbra
::Source: https://github.com/mribraqdbra/HSS_Counter_Logs
::==============================
::::::::::::::::::::::::::::::[main:start]
:main
color %colorcode%
...
echo. HSS Counter v1.2 >>HSS_Counter_Logs\hsscounter.log
...
setlocal EnableDelayedExpansion
set stuffname="?"
%input% "prompt=Stuff(Name):" "length=6" "allowed=a A b B c C d D e E f F g G h H i I j J k K l L m M n N o O p P q Q r R s S t T u U v V w W x X y Y z Z +"
setlocal DisableDelayedExpansion
if /i %stuffname%==+ goto main
echo.
echo.
:: Advanced user input in batch [using xcopy]
:: Source: https://superuser.com/questions/1290375/limit-length-of-user-input-batch
...
if /i %vieworedit%==5 goto deletealllogs
if /i %vieworedit%==+ goto main
cls
goto vieworedit
::::::::::::::::::::::::::::::[vieworedit:end]
echo.
